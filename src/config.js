...
export const siteConfig = {
  ...
  projects: [
    ...
    },
    {
      id: 6,
      title: 'DNO-Encryptx',
      description: 'Herramienta fundacional de ciberseguridad (CMD). Encriptación de datos base para operaciones en terminales.',
      image: null, 
      type: 'tool',
      tags: ['Python', 'CLI', 'Cybersecurity', 'Cryptography'],
      urlLive: null,
      urlGithub: 'https://github.com/root3355/DNO-Encryptx',
      status: 'STABLE'
    }
  ],
