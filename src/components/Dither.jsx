...
// OPTIMIZACIÓN 1: Reducimos OCTAVES de 4 a 2 para mejorar los FPS drásticamente
const int OCTAVES = 2;
float fbm(vec2 p) {
  float value = 0.0;
  float amp = 1.0;
...
export default function Dither({
  ...
  return (
    <Canvas
      ...
      // OPTIMIZACIÓN 2: Desactivamos el antialias y pedimos alto rendimiento gráfico
      dpr={[0.5, 1]} 
      gl={{ 
        antialias: false, 
